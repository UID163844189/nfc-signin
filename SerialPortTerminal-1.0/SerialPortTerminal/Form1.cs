...
namespace SerialPortTerminal
{
	public partial class Form1 : Form
	{
		...
		{
			string ComingData = serialPort.ReadLine() + "\n";
		...
		{
			if (!File.Exists(textBoxSavingPath.Text))
			{
				File.Create(textBoxSavingPath.Text).Close();
			}
			File.WriteAllText(textBoxSavingPath.Text, DataToSave);
		}
